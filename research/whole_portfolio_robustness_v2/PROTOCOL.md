...
Settlement is processed on every calendar date, not deferred to an XNYS session. A receivable paid on a non-XNYS date settles after accrual for the preceding day, earns interest beginning with the next calendar day's opening balance, and appears as settled cash plus all subsequent daily interest in the next XNYS NAV. This rule applies to the frozen TMO 2023-01-16 and TSM 2025-01-09 non-XNYS payable-date boundaries.
