...
class TestCatalogAndRegisterSynchronisation:
    ...
    def test_workstream_live_fields_reflect_this_session(self) -> None:
        ...
        # ADVANCED BY PR #364: the live register now names this PR's verified main base.
        assert workstream["last_verified_main_sha"] == PR364_MAIN_SHA
        ...
        assert str(workstream["last_verified_date"]).startswith("2026-09-03")
        ...
        assert workstream["active_pr"] == PR364_ACTIVE_PR
