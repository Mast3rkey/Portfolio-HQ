...
Intuitive Surgical supplies robotic-assisted surgical systems -- the
...
- Recurring revenue (instruments and accessories, service) continues
  growing at or above recently reported rates, without a material,
  sustained reversal
- da Vinci and Ion procedure growth continues at or above recently
  reported levels
...
- A material, sustained deceleration or reversal in recurring revenue
  growth
...
No catalyst entry is included in this record's structured schema.
Continued da Vinci 5 platform adoption and continued Ion platform
procedure growth are both directionally relevant to this thesis, but
...
- **Cadence: 90 days.** Matches COST's, XOM's, NVDA's, and GEV's
  cadence, and the `life_sciences_tools_medtech` theme's own cadence.
- **Unscheduled-review triggers** (qualitative, observable, same
  pattern established elsewhere in this corpus):
  - A material, sustained deceleration or reversal in recurring
    revenue growth
  - A material, sustained deceleration in procedure growth
  - A disclosed, material execution failure in the da Vinci 5 rollout
  - Evidence of material competitive share loss to Hugo, OTTAVA, or
...
References the `life_sciences_tools_medtech` Theme Intelligence record
(`intelligence/themes/life_sciences_tools_medtech.yaml`/`.md`). ISRG's
disclosed revenue is derived overwhelmingly from device sales
(systems) plus recurring, procedure-linked revenue (instruments and
accessories, and service) -- exactly the disclosed business pattern
the theme's non-membership rule requires for the medical/surgical-
device sub-industry, with no material unrelated business line diluting
the fit. Per PI-0006's frozen one-way-authority model, this file
references the theme; the theme file does not reference ISRG back.
Theme membership does not imply anything about ISRG's allocator
treatment, tier weight, or cluster-cap status, all of which remain
governed exclusively by `targets.yaml`.
