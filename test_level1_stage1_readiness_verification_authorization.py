...
class TestThisFilingMutatesNothingLoadBearing:
    ...
    def test_canonical_bytes_match_the_effective_v7_pins(self) -> None:
        ...
        assert A.CANONICAL_PINS[A.CANONICAL_PROTOCOL_RELPATH] == PROTOCOL_SHA256
        assert A.CANONICAL_PINS[A.CANONICAL_PREREGISTRATION_RELPATH] == PREREG_SHA256
...
class TestCatalogAndRegisterSynchronisation:
    ...
    def test_workstream_live_fields_reflect_this_session(self) -> None:
        ...
        # ADVANCED BY THE XASSET-0040 CORRECTION, for the same reason `last_verified_main_sha`
        # advances above: `active_pr` is WS-0014's single shared live field, and PR #340 is now the
