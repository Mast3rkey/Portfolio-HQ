...
Waiting for approval before starting Phase 2B. *(Still accurate as of the 2026-07-18 correction — 2A and 2D shipped, but 2B has not; see the STATUS CORRECTION banner above.)*
