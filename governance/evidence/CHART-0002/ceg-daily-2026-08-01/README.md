# CHART-0002 Batch 1 -- CEG daily chart evidence
...
package is CEG's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** CEG (Constellation Energy Corporation), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical CEG daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/CEG/CEG__2026-08-01__1D.png`,
...
- `CEG__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `0ceea1cd8e2434512129ccd71ab01e4aa23b52af34f422a5c5bb1da1ef28e884`, 1,802,059 bytes, PNG, 3624x2336.
...
session, that `CEG__2026-08-01__1D.png` is the canonical CEG daily
...
TradingView.com, Aug 01, 2026 14:46 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/CEG.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change CEG's tier, target, or canonical destination
...
second batch, a second timeframe for CEG, Stage 2 cross-timeframe
