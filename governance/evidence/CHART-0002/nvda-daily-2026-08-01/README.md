# CHART-0002 Batch 1 -- NVDA daily chart evidence
...
package is NVDA's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- `NVDA__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `0ddc0eb0aded012618c368343f657f983d5bb9db7d130f58965f4bb542c4055f`, 1,877,385 bytes, PNG, 3624x2336.
...
session, that `NVDA__2026-08-01__1D.png` is the canonical NVDA daily
...
TradingView.com, Aug 01, 2026 14:16 UTC-4". CHART-0001 Section 5
...
- does **not** change NVDA's tier, target, or canonical destination
...
second batch, a second timeframe for NVDA, Stage 2 cross-timeframe
