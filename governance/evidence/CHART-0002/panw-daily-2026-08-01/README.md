# CHART-0002 Batch 1 -- PANW daily chart evidence
...
package is PANW's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** PANW (Palo Alto Networks, Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical PANW daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/PANW/PANW__2026-08-01__1D.png`,
...
- `PANW__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `8fddf2c43e637515511005bbf6c3fb1ac06d1c341890eae05f772385e3af4c78`, 1,589,419 bytes, PNG, 3414x2252.
...
session, that `PANW__2026-08-01__1D.png` is the canonical PANW daily
...
TradingView.com, Aug 01, 2026 15:39 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/PANW.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change PANW's tier, target, or canonical destination
...
second batch, a second timeframe for PANW, Stage 2 cross-timeframe
