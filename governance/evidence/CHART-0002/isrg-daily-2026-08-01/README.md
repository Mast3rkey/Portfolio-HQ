# CHART-0002 Batch 1 -- ISRG daily chart evidence
...
package is ISRG's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** ISRG (Intuitive Surgical, Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical ISRG daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/ISRG/ISRG__2026-08-01__1D.png`,
...
- `ISRG__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `528fc4c77b27776fb231f30a6592443679ea36538be9f54b57eaad0f1c5f68b4`, 1,753,268 bytes, PNG, 3624x2336.
...
session, that `ISRG__2026-08-01__1D.png` is the canonical ISRG daily
...
TradingView.com, Aug 01, 2026 14:54 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/ISRG.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change ISRG's tier, target, or canonical destination
...
second batch, a second timeframe for ISRG, Stage 2 cross-timeframe
