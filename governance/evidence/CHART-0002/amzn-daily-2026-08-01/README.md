# CHART-0002 Batch 1 -- AMZN daily chart evidence
...
package is AMZN's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** AMZN (Amazon.com, Inc), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical AMZN daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/AMZN/AMZN__2026-08-01__1D.png`,
...
- `AMZN__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `e593d332ea6702fc735e41543d078156e0d25e98e8de34362b5f8f69e266b6df`, 1,804,249 bytes, PNG, 3624x2336.
...
session, that `AMZN__2026-08-01__1D.png` is the canonical AMZN daily
...
- does **not** change `intelligence/companies/AMZN.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change AMZN's tier, target, or canonical destination
...
second batch, a second timeframe for AMZN, Stage 2 cross-timeframe
