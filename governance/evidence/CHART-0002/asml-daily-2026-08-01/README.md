# CHART-0002 Batch 1 -- ASML daily chart evidence
...
package is ASML's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** ASML (ASML Holding N.V. - New York Registry Shares), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical ASML daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/ASML/ASML__2026-08-01__1D.png`,
...
- `ASML__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `c79d0c1ae0a38156e186c249cb89c5ab45685da36d4ca93161f808da6783cdbb`, 1,769,257 bytes, PNG, 3624x2336.
...
session, that `ASML__2026-08-01__1D.png` is the canonical ASML daily
...
TradingView.com, Aug 01, 2026 16:42 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/ASML.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change ASML's tier, target, or canonical destination
...
second batch, a second timeframe for ASML, Stage 2 cross-timeframe
