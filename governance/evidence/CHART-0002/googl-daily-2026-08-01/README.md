# CHART-0002 Batch 1 -- GOOGL daily chart evidence
...
package is GOOGL's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** GOOGL (Alphabet Inc (Google) Class A), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical GOOGL daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/GOOGL/GOOGL__2026-08-01__1D.png`,
...
- `GOOGL__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `b54f7fc6d95a7545d55b941a60868acc7fec2f8d30719672aab89dcca2378aab`, 1,814,352 bytes, PNG, 3624x2336.
...
session, that `GOOGL__2026-08-01__1D.png` is the canonical GOOGL daily
...
TradingView.com, Aug 01, 2026 14:33 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/GOOGL.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change GOOGL's tier, target, or canonical destination
...
second batch, a second timeframe for GOOGL, Stage 2 cross-timeframe
