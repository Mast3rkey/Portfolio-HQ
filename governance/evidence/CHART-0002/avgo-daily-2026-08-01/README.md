# CHART-0002 Batch 1 -- AVGO daily chart evidence
...
package is AVGO's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** AVGO (Broadcom Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical AVGO daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/AVGO/AVGO__2026-08-01__1D.png`,
...
- `AVGO__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `4a2d70834fbb31dfe7f6b570936508a82e46dd7dc352aa5b7b769d2c797f8608`, 1,769,450 bytes, PNG, 3624x2336.
...
session, that `AVGO__2026-08-01__1D.png` is the canonical AVGO daily
...
- does **not** change `intelligence/companies/AVGO.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change AVGO's tier, target, or canonical destination
...
second batch, a second timeframe for AVGO, Stage 2 cross-timeframe
