# CHART-0002 Batch 1 -- PWR daily chart evidence
...
package is PWR's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** PWR (Quanta Services, Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical PWR daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/PWR/PWR__2026-08-01__1D.png`,
...
- `PWR__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `6bcdee4c6a822d386c2274f253d819749dfd061f09b06a7572ae8c16ee21fac8`, 1,750,704 bytes, PNG, 3624x2336.
...
session, that `PWR__2026-08-01__1D.png` is the canonical PWR daily
...
- does **not** change `intelligence/companies/PWR.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change PWR's tier, target, or canonical destination
...
second batch, a second timeframe for PWR, Stage 2 cross-timeframe
