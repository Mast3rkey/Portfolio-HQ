# CHART-0002 Batch 1 -- TMO daily chart evidence
...
package is TMO's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** TMO (Thermo Fisher Scientific Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical TMO daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/TMO/TMO__2026-08-01__1D.png`,
...
- `TMO__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `d5b106b887e53cbfdf8c3c4464fca5276a12033b704d8610739ff124f8f65d69`, 1,775,575 bytes, PNG, 3624x2336.
...
session, that `TMO__2026-08-01__1D.png` is the canonical TMO daily
...
- does **not** change `intelligence/companies/TMO.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change TMO's tier, target, or canonical destination
...
second batch, a second timeframe for TMO, Stage 2 cross-timeframe
