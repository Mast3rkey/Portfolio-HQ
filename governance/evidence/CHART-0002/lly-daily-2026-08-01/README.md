# CHART-0002 Batch 1 -- LLY daily chart evidence
...
package is LLY's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** LLY (Eli Lilly and Company.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical LLY daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/LLY/LLY__2026-08-01__1D.png`,
...
- `LLY__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `f4caa388a95ca2338996378e6b20d333b71acac4a6214a6e4dc0c25bd2770c66`, 1,626,453 bytes, PNG, 3414x2252.
...
session, that `LLY__2026-08-01__1D.png` is the canonical LLY daily
...
TradingView.com, Aug 01, 2026 15:45 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/LLY.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change LLY's tier, target, or canonical destination
...
second batch, a second timeframe for LLY, Stage 2 cross-timeframe
