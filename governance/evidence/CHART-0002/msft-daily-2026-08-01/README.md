# CHART-0002 Batch 1 -- MSFT daily chart evidence
...
package is MSFT's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** MSFT (Microsoft Corp.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical MSFT daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/MSFT/MSFT__2026-08-01__1D.png`,
...
- `MSFT__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `17ec0465eec0ef67d9989b8308ed5750b1c0b3894d9773a192c3327cf001bbe4`, 1,754,413 bytes, PNG, 3624x2336.
...
session, that `MSFT__2026-08-01__1D.png` is the canonical MSFT daily
...
- does **not** change `intelligence/companies/MSFT.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change MSFT's tier, target, or canonical destination
...
second batch, a second timeframe for MSFT, Stage 2 cross-timeframe
