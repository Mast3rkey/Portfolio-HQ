# CHART-0002 Batch 1 -- ETN daily chart evidence
...
package is ETN's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** ETN (Eaton Corporation Plc), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical ETN daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/ETN/ETN__2026-08-01__1D.png`,
...
- `ETN__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `c46175d7b2078d3584e6ab933f0f94d78138066ce15e244bf03a9903786aeebc`, 1,851,213 bytes, PNG, 3624x2336.
...
session, that `ETN__2026-08-01__1D.png` is the canonical ETN daily
...
- does **not** change `intelligence/companies/ETN.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change ETN's tier, target, or canonical destination
...
second batch, a second timeframe for ETN, Stage 2 cross-timeframe
