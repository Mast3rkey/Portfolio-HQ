# CHART-0002 Batch 1 -- KLAC daily chart evidence
...
package is KLAC's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** KLAC (KLA Corporation), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical KLAC daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/KLAC/KLAC__2026-08-01__1D.png`,
...
- `KLAC__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `55b6a010d91837e51aa8fc3a9fa28c1633a6a38d42d8b9a226c4f226f20e3f72`, 1,771,405 bytes, PNG, 3624x2336.
...
session, that `KLAC__2026-08-01__1D.png` is the canonical KLAC daily
...
- does **not** change `intelligence/companies/KLAC.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change KLAC's tier, target, or canonical destination
...
second batch, a second timeframe for KLAC, Stage 2 cross-timeframe
