# CHART-0002 Batch 1 -- V daily chart evidence
...
package is V's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** V (Visa Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical V daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/V/V__2026-08-01__1D.png`,
...
- `V__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `378844f781507e246cebcdb6c153c9b9ab4e6b8118c6cc9f8fe2d58a9b399ea8`, 1,816,385 bytes, PNG, 3624x2336.
...
session, that `V__2026-08-01__1D.png` is the canonical V daily
...
TradingView.com, Aug 01, 2026 15:05 UTC-4". CHART-0001 Section 5
...
- does **not** change `intelligence/companies/V.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change V's tier, target, or canonical destination
...
second batch, a second timeframe for V, Stage 2 cross-timeframe
