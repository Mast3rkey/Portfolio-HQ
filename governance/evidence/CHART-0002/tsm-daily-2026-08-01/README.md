# CHART-0002 Batch 1 -- TSM daily chart evidence
...
package is TSM's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** TSM (Taiwan Semiconductor Manufacturing Company Ltd), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical TSM daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/TSM/TSM__2026-08-01__1D.png`,
...
- `TSM__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `35c885283335e298eb9331eae0464a729bddc29cf36a4b63cc19479834b099b2`, 1,833,071 bytes, PNG, 3624x2336.
...
session, that `TSM__2026-08-01__1D.png` is the canonical TSM daily
...
- does **not** change `intelligence/companies/TSM.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change TSM's tier, target, or canonical destination
...
second batch, a second timeframe for TSM, Stage 2 cross-timeframe
