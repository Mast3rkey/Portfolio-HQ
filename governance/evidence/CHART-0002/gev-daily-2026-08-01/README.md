# CHART-0002 Batch 1 -- GEV daily chart evidence
...
package is GEV's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** GEV (GE Vernova Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical GEV daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/GEV/GEV__2026-08-01__1D.png`,
...
- `GEV__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `979664a076f23c7c663a53fbefda4a60d832daede3d58f902ad402b9289f5b20`, 1,802,578 bytes, PNG, 3624x2336.
...
session, that `GEV__2026-08-01__1D.png` is the canonical GEV daily
...
- does **not** change `intelligence/companies/GEV.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change GEV's tier, target, or canonical destination
...
second batch, a second timeframe for GEV, Stage 2 cross-timeframe
