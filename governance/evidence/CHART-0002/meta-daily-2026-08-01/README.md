# CHART-0002 Batch 1 -- META daily chart evidence
...
package is META's share of the first 19-ticker batch: `AMZN, ASML, AVGO,
...
- **Asset:** META (Meta Platforms, Inc.), equity.
- **Timeframe:** daily (1D).
- **Source:** the sole canonical META daily screenshot in the read-only,
  externally governed Chart-Automation library
  (`Chart-Automation/library/governed/2026-08-01/META/META__2026-08-01__1D.png`,
...
- `META__2026-08-01__1D.png` -- the retained chart image. **Byte-for-byte
  identical** to the governed source (no redaction applied -- see Privacy
  below). SHA-256 `21357ea481e48dd031f2b833716d5ec9a681406812f2d847f4b17c801d1c8f95`, 1,784,290 bytes, PNG, 3624x2336.
...
session, that `META__2026-08-01__1D.png` is the canonical META daily
...
- does **not** change `intelligence/companies/META.yaml` or any other
  Company/Theme Intelligence record;
- does **not** change META's tier, target, or canonical destination
...
second batch, a second timeframe for META, Stage 2 cross-timeframe
